        ...
        >
          {({ open }) => (
            <div className="flex flex-col">
              <label htmlFor="transportation_by" className="block mb-3 text-2xl font-medium ">
                Transportation By<span className="text-[red]">*</span>
              </label>
              <div className="relative mt-1">
                <Listbox.Button className="relative w-full cursor-default rounded-lg border hover:border-[#4F46E5] border-gray-300 bg-[color:rgba(var(--background),1)] py-5 pl-3 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                  <span className="flex items-center">
                    <img src={selected.icon} alt="" className="h-8 w-8 flex-shrink-0 rounded-full" />
                    <span className="ml-3 text-xl block truncate">{selected.transportation_by}</span>
                  </span>
                ...
                <Transition show={open} as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                  <Listbox.Options className="absolute z-10 mt-1 max-h-72 w-full overflow-auto rounded-lg bg-[color:rgba(var(--background),1)] py-1 text-xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        ...
                        {({ selected, active }) => (
                          <>
                            <div className="flex items-center">
                              ...
                              <span className={classNames(selected ? 'font-semibold' : 'font-normal', 'ml-3 block truncate text-xl')}>
      ...
      {selected.id === 1 ? (
        <div className="grid gap-6 mb-8 md:grid-cols-2">
          ...
          >
            {({ open }) => (
              <div className="flex flex-col">
                <label htmlFor="container_type" className="block mb-3 text-2xl font-medium">
                ...
                <div className="relative mt-1">
                    ...
                    <span className="flex items-center">
                      <span className="ml-3 block truncate text-xl">
                        {selectedContainer?.['container_type'] ? (
                          ...
                          <p className="text-gray-400 text-xl">Choose Container</p>
                        )}
                      </span>
                    </span>
                    <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2">
                  ...
                  <Transition show={open} as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                    <Listbox.Options className="absolute z-10 mt-1 max-h-72 w-full overflow-auto rounded-md bg-[color:rgba(var(--background),1)] py-1 text-xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          ...
          <div>
            <label htmlFor="Quanity of Containers" className="block mb-3 text-2xl font-medium">
        ...
        <div>
          <div className="mb-5">
            ...
            />
            <label htmlFor="bordered-checkbox-1" className="py-4 ml-4 w-full text-2xl font-medium">
              By Units
            </label>
          </div>
          ...
          <div>
            {byUnits ? (
              ...
              <div className="grid gap-6 mb-8 md:grid-cols-2">
                {' '}
                <div>
                  <label htmlFor="weight" className="block mb-3 text-2xl font-medium">
                    Weight <span className="text-[red]">*</span>
                  </label>
                  <div className="flex items-center bg-[color:rgba(var(--background),1)] rounded-lg border border-gray-300 focus:outline-[#4F46E5] hover:border-[#4F46E5]  w-full">
                    <input
                      type="number"
                      name="weight"
                      onChange={(e) => handleChange(e)}
                      className="bg-[color:var(--inputBackground)]  text-2xl p-5 outline-none w-[85%]"
                      placeholder="0"
                      required
                      onInvalid={(e) => {
                    ...
                    />
                    <div className="w-[15%] border-l-2 border-gray-300 text-gray-500 text-2xl flex justify-center items-center">kg</div>
                  </div>
                </div>
                <div>
                  <label htmlFor="volume" className="block mb-3 text-2xl font-medium">
                  ...
                  <div className="flex items-center bg-[color:rgba(var(--background),1)] rounded-lg border border-gray-300 focus:outline-[#4F46E5] hover:border-[#4F46E5]  w-full">
                    ...
                    />
                    <div className="w-[15%] border-l-2 border-gray-300 text-gray-500 text-2xl flex justify-center items-center">m³</div>
                  </div>
                </div>
              </div>
            )}
        ...
        <>
          <div className="grid gap-6 mb-8 md:grid-cols-2">
            ...
            >
              {({ open }) => (
                <div className="flex flex-col">
                  <label htmlFor="ship_type" className="block mb-3 text-2xl font-medium">
                    Ship Type
                  </label>
                  <div className="relative mt-1">
                    <Listbox.Button className="relative w-full cursor-default rounded-md border hover:border-[#4F46E5] border-gray-300 bg-[color:rgba(var(--background),1)] py-5 pl-3 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                      <span className="flex items-center">
                        <span className="ml-3 block truncate text-xl">{selectedShipType.shiptype}</span>
                      </span>
                      <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2">
                        <ChevronDownIcon className="h-6 w-6 text-gray-400" aria-hidden="true" />
                      </span>
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0"
                    >
                      <Listbox.Options className="absolute z-10 mt-1 max-h-80 w-full overflow-auto rounded-lg bg-[color:rgba(var(--background),1)] py-1 text-xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        {shiptypes.map((type) => (
                          <Listbox.Option
                            key={type.id}
                            className={({ active }) =>
            ...
            <div>
              <label htmlFor="Gross Weight" className="block mb-3 text-2xl font-medium">
          ...
          <div className="grid gap-6 mb-8 md:grid-cols-2">
            ...
            <div>
              <label htmlFor="Discharging Rate" className="block mb-3 text-2xl font-medium">
                Discharging Rate
              </label>
              <div className="flex items-center bg-[color:rgba(var(--background),1)] rounded-lg border border-gray-300 focus:outline-[#4F46E5] hover:border-[#4F46E5]  w-full">
                <input
                  ...
                  onChange={(e) => handleChange(e)}
                  className="bg-[color:var(--inputBackground)]  text-2xl p-5 outline-none w-[80%]"
                  placeholder="0"
                />
                <div className="w-[20%] border-l-2 border-gray-300 text-gray-500 text-2xl flex justify-center items-center">kg/day</div>
              </div>
            </div>
          </div>
        </>
