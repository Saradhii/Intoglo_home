    ...
    <>
      <div className="mt-10 px-2 grid grid-cols-2 gap-3 mb-6 md:grid-cols-4 sm:grid-cols-2 flex-wrap">
        <button
          ...
          className={
            hazardousCargo
              ? 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#f12711] via-[#c99118] to-[#f5af19] border-[1px] border-[#c99118]'
              : 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 border  rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#f12711] via-[#c99118] to-[#f5af19]'
          }
        >
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="w-5 h-5 text-[color:var(--text)]"
          >
            <path
              strokeLinecap="round"
        ...
        <button
          ...
          className={
            perishableCargo
              ? 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#c0c0aa] via-[#32dbe8] to-[#1cefff] border-[1px] border-[#32dbe8]'
              : 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 border  rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#c0c0aa] via-[#32dbe8] to-[#1cefff]'
          }
        >
          <svg className="svg-icon w-5 h-5 text-[color:var(--text)]" viewBox="0 0 20 20" strokeWidth="1.5" stroke="currentColor">
            <path
              fill="none"
        ...
        <button
          ...
          className={
            oversizedCargo
              ? 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#0f0c29] via-[#342e79] to-[#302b63] border-[1px] border-[#342e79]'
              : 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 border  rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#0f0c29] via-[#342e79] to-[#302b63]'
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          ...
          className={
            liquidCargo
              ? 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#1CD8D2] via-[#77dfb3] to-[#93EDC7] border-[1px] border-[#77dfb3]'
              : 'inline-flex items-center justify-center gap-2 px-4 py-3 text-xl font-thin text-center text-gray-500 border  rounded-full shadow-2xl  cursor-pointer hover:text-white bg-[color:rgba(var(--background),1)] hover:bg-gradient-to-br from-[#1CD8D2] via-[#77dfb3] to-[#93EDC7]'
          }
        >
          <svg className="svg-icon w-5 h-5 text-[color:var(--text)]" viewBox="0 0 20 20" strokeWidth="1.5" stroke="currentColor">
            <path
          ...
          <span className="relative font-thin truncate">Liquid Cargo</span>
        </button>
      </div>
      {hazardousCargo ? (
        <div className="grid gap-6 mb-6 md:grid-cols-2">
          ...
          >
            {({ open }) => (
              <div className="flex flex-col">
                <label htmlFor="imo_class" className="block mb-2 text-xl font-medium">
                  Imo Class<span className="text-[red]">*</span>
                </label>
                <div className="relative mt-1">
                  <Listbox.Button className="relative w-[81%] cursor-default rounded-md border hover:border-[#4F46E5] border-gray-300 bg-[color:rgba(var(--background),1)] py-5 pl-3 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                  ...
                  <Transition show={open} as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                    <Listbox.Options className="absolute z-10 mt-1 max-h-64 w-full overflow-auto rounded-lg bg-[color:rgba(var(--background),1)] py-1 text-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      {imo_class.map((imoclass) => (
                        <Listbox.Option
                          key={imoclass.id}
                          className={({ active }) =>
                            classNames(
                              active ? 'text-white bg-indigo-600' : 'text-[color:var(--text)]',
          ...
          <div className="w-[81%] sm:w-full">
            ...
            <input
              type="number"
              name="un_number"
              className="bg-[color:var(--inputBackground)] rounded-lg border border-gray-300 text-lg focus:outline-[#4F46E5] hover:border-[#4F46E5] block w-full p-5 mb-2"
              placeholder="0"
              required
              onInvalid={(F) => {
      ...
      {perishableCargo ? (
        <div className="grid gap-6 mb-6 md:grid-cols-2">
          <div>
            ...
            <div className="border flex space-between items-center rounded-lg focus:outline-[#4F46E5] hover:border-[#4F46E5] bg-[color:rgba(var(--background),1)]">
              <input
                type="number"
                name="temperature_regime"
                className="bg-[color:var(--inputBackground)] text-lg outline-none block p-5 w-full"
                placeholder="0"
                onChange={(e) => {
                  setFormData({
                    ...formData,
              ...
              >
                {({ open }) => (
                  <div className="relative">
                    <Listbox.Button className="relative w-full cursor-default border-l-[1px] text-lg border-gray-300 bg-[color:rgba(var(--background),1)] py-5 pl-3 pr-10 text-left shadow-sm focus:outline-none">
                      <span className="flex items-center">
                        <span className="ml-3 block truncate">{selectedTempType.type}</span>
                      </span>
                      <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2">
                        <ChevronDownIcon className="h-6 w-5 text-gray-400" aria-hidden="true" />
                      </span>
                    </Listbox.Button>
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0"
                    >
                      <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-full text-lg overflow-auto rounded-md bg-[color:rgba(var(--background),1)] py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        {temptype.map((type) => (
                          <Listbox.Option
                            key={type.id}
                            className={({ active }) =>
                              classNames(
                                active ? 'text-white bg-indigo-600' : 'text-[colot:var(--text)]',
      ...
      {oversizedCargo ? (
        <div className="grid gap-6 mb-6 md:grid-cols-3">
          <div>
            <label htmlFor="length" className="block mb-2 text-xl font-medium">
              Length
            </label>
            <div className="border flex space-between items-center rounded-lg focus:outline-[#4F46E5] hover:border-[#4F46E5] bg-[color:rgba(var(--background),1)]">
              <input
                type="text"
                autoComplete="off"
                className="bg-[color:var(--inputBackground)] text-lg block w-[80%] p-5 outline-none focus:outline-none"
                placeholder="0"
                onChange={(e) => {
                  setFormData({
                    ...formData,
              ...
              />
              <div className="flex justify-center items-center border-l-2 w-[20%] text-lg text-gray-500 font-thin">m</div>
            </div>
          </div>
          <div>
            <label htmlFor="width" className="block mb-2 text-xl font-medium">
              Width
            </label>
            <div className="border flex space-between items-center rounded-lg focus:outline-[#4F46E5] hover:border-[#4F46E5] bg-[color:rgba(var(--background),1)]">
              <input
