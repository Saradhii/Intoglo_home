  ...
  return (
    <div className="flex flex-col items-start sm:flex-row sm:items-center gap-x-10 mb-8 w-[80%] sm:w-[70%] md:w-[110%] md:gap-3 xl:w-[120%] xl:gap-x-6 flex-wrap">
      <button
        ...
        className={
          insurance
            ? 'relative inline-flex text-xl  items-center justify-between gap-4 mb-2 px-6 py-4  hover:shadow-2xl shadow-md border rounded-full md:w-auto  border-[#4F46E5]'
            : 'relative inline-flex text-xl items-center justify-between gap-4 mb-2 px-6 py-4  hover:shadow-2xl shadow-md border border-transparent rounded-full md:w-auto hover:border-[#4F46E5]'
        }
      >
        <input
          id="link-checkbox"
        ...
        {insuranceInfo ? (
          <div className=" absolute bottom-20 -left-32 max-w-lg text-xl md:w-[350px] rounded-lg shadow-lg p-4 bg-[#4F46E5]">
      ...
      <button
        ...
        className={
          inspection
            ? 'relative inline-flex text-xl items-center justify-between gap-4 mb-2 px-6 py-4  hover:shadow-2xl sm:ml-4 xl:ml-0 shadow-md border border-transparent rounded-full md:w-auto  border-[#4F46E5]'
            : 'relative inline-flex text-xl items-center justify-between gap-4 mb-2 px-6 py-4  hover:shadow-2xl sm:ml-4 xl:ml-0 shadow-md border border-transparent rounded-full md:w-auto hover:border-[#4F46E5]'
        }
      >
        <input
          id="link-checkbox"
        ...
        {inspectionInfo ? (
          <div className=" absolute bottom-20 -left-24 max-w-lg text-xl md:w-[350px] rounded-lg shadow-lg p-4 bg-[#4F46E5]">
      ...
      <button
        ...
        className={
          certification
            ? 'relative inline-flex text-xl items-center justify-between gap-4 mb-2 px-6 py-4  hover:shadow-2xl shadow-md border border-transparent rounded-full md:w-auto  border-[#4F46E5]'
            : 'relative inline-flex text-xl items-center justify-between gap-4 mb-2 px-6 py-4  hover:shadow-2xl shadow-md border border-transparent rounded-full md:w-auto hover:border-[#4F46E5]'
        }
      >
        <input
        ...
        {certificationInfo ? (
          <div className=" absolute bottom-20 -left-28 max-w-lg text-xl md:w-[350px] rounded-lg shadow-lg p-4 bg-[#4F46E5]">
