    ...
    <>
              ...
              <div className="relative mt-1">
                <Listbox.Button className="relative w-full cursor-default rounded-lg border hover:border-[#4F46E5] border-gray-300 bg-[color:rgba(var(--background),1)] py-5 pl-3 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                  <span className="flex items-center">
                    ...
                    <span className="ml-3 block truncate text-xl">{selected.transportation_by}</span>
                  </span>
      ...
      {selected.id === 1 ? (
              ...
              <div className="grid gap-6 mb-8 md:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="flex items-center bg-[color:rgba(var(--background),1)] rounded-lg border border-gray-300 focus:outline-[#4F46E5] hover:border-[#4F46E5]  w-full">
                    ...
                    />
                    <div className="w-[15%] border-l-2 border-gray-300 text-gray-500 text-xl flex justify-center items-center">m³</div>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="grid gap-6 mb-8 md:grid-cols-2">
            ...
            {({ open }) => (
              <div className="flex flex-col">
                ...
                <div className="relative mt-1">
                  ...
                  <Transition show={open} as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                    <Listbox.Options className="absolute z-10 mt-1 max-h-80 w-full overflow-auto rounded-lg bg-[color:rgba(var(--background),1)] py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          ...
          <div>
            <label htmlFor="Quantity of Containers" className="block mb-3 text-2xl font-medium ">
