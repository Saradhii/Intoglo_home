  ...
  return (
    <div className="grid gap-2 mb-6 grid-cols-3 w-[80%] sm:grid-cols-3 sm:w-[60%] sm:gap-4 md:grid-cols-3 md:w-[50%] md:gap-6 lg:grid-cols-6 xl:grid-cols-6 lg:w-[100%] lg:gap-4 xl:w-[90%]">
      <button
        ...
        className={
          exw
            ? 'inline-flex text-2xl text-2xl items-center justify-between gap-2 mb-2 px-5 md:px-7 py-4 hover:shadow-2xl shadow-xl border rounded-full md:w-auto  border-[#4F46E5]'
            : 'inline-flex text-2xl text-2xl items-center justify-between gap-2 mb-2 px-5 md:px-7 py-4 hover:shadow-2xl shadow-xl border border-transparent rounded-full md:w-auto hover:border-[#4F46E5] focus:outline-none'
        }
      >
        <input
          id="link-checkbox"
      ...
      <button
        ...
        className={
          fob
            ? 'inline-flex text-2xl items-center justify-between gap-2 mb-2 px-6 md:px-7 py-2 hover:shadow-2xl shadow-xl border rounded-full md:w-auto  border-[#4F46E5]'
            : 'inline-flex text-2xl items-center justify-between gap-2 mb-2 px-6 md:px-7 py-2 hover:shadow-2xl shadow-xl border border-transparent rounded-full md:w-auto hover:border-[#4F46E5] focus:outline-none'
        }
      >
        <input
          id="link-checkbox"
      ...
      <button
        ...
        className={
          ddp
            ? 'inline-flex text-2xl items-center justify-between gap-2 mb-2 px-6 md:px-7 py-2 hover:shadow-2xl shadow-xl border rounded-full md:w-auto  border-[#4F46E5]'
            : 'inline-flex text-2xl items-center justify-between gap-2 mb-2 px-6 md:px-7 py-2 hover:shadow-2xl shadow-xl border border-transparent rounded-full md:w-auto hover:border-[#4F46E5]'
        }
      >
        <input
          id="link-checkbox"
